...
export const Edit = ({ onClick, dimensions }:IconParams) => {
    return (
...
export const Trash = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}
            onClick={onClick}
        >
...
export const Check = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}
            onClick={()=>{
                onClick && onClick()}}
...
export const Reload = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}
            onClick={onClick}
        >
...
export const Cancel = ({ onClick, dimensions }:IconParams) => {//x-mark icon....
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}
            onClick={onClick}
        >
...
export const EllipsisHorizontal = ({ onClick, hoverColor, dimensions }:IconParams) => {
    return (
        <svg 
...
export const BankNotes = ({ dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
...
export const ChevDown = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg 
            xmlns="http://www.w3.org/2000/svg" 
            fill="none" 
...
export const ChevUp = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg 
            xmlns="http://www.w3.org/2000/svg" 
            fill="none" 
...
export const Eye = ({onClick, dimensions }:IconParams) => {
    return (
        <svg 
...
export const EyeSlash = ({ onClick }:IconParams) => {
    return (
...
export const Plus = ({ onClick, strokeColor }:IconParams) => {
    return (
...
export const PlusCircle = ({ onClick, strokeColor, dimensions}:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" 
            className={`w-6 h-6 ${strokeColor && strokeColor}`}
            onClick={onClick}
...
export const Minus = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
...
export const MinusCircle = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
...
export const XCircle = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}
            onClick={onClick}
        >
...
export const XMark = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
        </svg>
...
export const ShopingCart = ({ onClick, strokeColor, dimensions }:IconParams) => {
    return (
...
export const Info = ({onClick, dimensions}:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
...
export const MagnifyingGlass = ({ onClick, disabled, dimensions }:IconParams) => {
    return (
        <svg 
...
export const ReloadArrow = ({ onClick, dimensions }:IconParams ) => {
    return (
...
export const Home = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
...
export const ShoppingBag = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
...
export const UserCircle = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
...
export const UserPlus = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
...
export const SignOut = ({ onClick, dimensions }:IconParams) => {//icon name on tailwind source list:arrow on left
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
...
export const SignIn = ({ onClick, dimensions }:IconParams) => {//icon name on tailwind source list:arrow on right
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
...
export const Programmer = ({ onClick, dimensions }:IconParams) => {
    return (
        <svg             
            xmlns="http://www.w3.org/2000/svg"      
...
export const ArrowSmallUp = ({dimensions}:IconParams) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${dimensions?dimensions:"w-6 h-6"}`}>
